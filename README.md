...
The static legal and support site for **Due This Week** — privacy policy, terms, support,
and the marketing page. Plain HTML and CSS, no build step.

This is a submodule of the [`due-this-week`](https://github.com/graboosky/due-this-week)
